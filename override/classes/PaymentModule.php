					...
					if ($id_order_state != Configuration::get('PS_OS_ERROR') && $id_order_state != Configuration::get('PS_OS_CANCELED') && $this->context->customer->id)
					{
						...
						if (Validate::isEmail($this->context->customer->email))
							...
							Mail::Send(
								(int)$order->id_lang,
								'order_conf',
								Mail::l('Nuevo pedido - #'.$order->id.' Realizado por: '.$this->context->customer->firstname.' '.$this->context->customer->lastname, (int)$order->id_lang),
								$data,
								'desarrollo@innovanity.com',
								null,
								null,
								null,
								$file_attachement,
